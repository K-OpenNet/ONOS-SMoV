...
public class SecurityModeManager implements SecurityAdminService {
    ...
    @Override
    public void updatePolicy(ApplicationId appId, Set<org.onosproject.security.Permission> permissions) {
        store.updatePolicy(appId, permissions);
        setLocalPermissions(appId);
    }
